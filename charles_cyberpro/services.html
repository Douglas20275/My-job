...
<head>
    ...
    <title>Services | Charlesabi Enterprises</title>
    ...
    <style>
        ...
        /* Hero Section for Services Page - now consistent with homepage hero */
    ...
    <script>
        ...
        window.addEventListener("load", () => {
            ...
            // Header scroll effect: change background and shadow on scroll - Added to services page
...
<body class="bg-backgroundLight text-textDark">
    ...
    <header class="header-gradient shadow-lg fixed w-full z-50 text-white">
        <div class="container mx-auto flex justify-between items-center p-4 md:p-6">
            ...
            <nav class="hidden md:flex space-x-8 text-base font-medium">
                ...
                <a href="services.php" class="block px-4 py-2 bg-accent text-primary rounded-md">Services</a> <!-- Active link for this page -->
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-primary text-white py-2">
            ...
            <a href="services.php" class="block active-link">Services</a>
    ...
    <section id="top" class="services-hero-section">
        <div class="services-hero-content animate-fade-in">
            <h2 class="text-4xl md:text-5xl lg:text-6xl font-playfair font-bold mb-6 leading-tight">
                Our Comprehensive Services
            </h2>
            <p class="text-lg md:text-xl mb-8 opacity-90">
                Tailored solutions for your digital, printing, and business needs.
            </p>
            <a href="#cyber" class="inline-block bg-accent text-primary px-8 py-4 rounded-full font-semibold text-lg hover:bg-white hover:text-accent transition duration-300 shadow-lg btn-primary-hover">
                Explore Our Services
            </a>
        </div>
    </section>

    <!-- Cyber Cafe & Digital Services Section -->
    <section id="cyber" class="py-16 md:py-24 text-textDark bg-section-parallax-1">
        <div class="w-full px-4 md:px-8 lg:px-16 py-8 bg-cardBg rounded-xl shadow-lg fade-in-on-scroll">
            <h2 class="text-4xl md:text-5xl font-playfair font-bold mb-12 text-center text-primary">Cyber Cafe & Digital Services</h2>
            <p class="text-lg text-gray-700 leading-relaxed text-center max-w-4xl mx-auto mb-16">
                Your one-stop digital hub for fast, reliable, and secure online and document services.
            </p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                <div class="bg-cardBg p-8 rounded-xl shadow-md text-center card-hover border border-subtleBorder fade-in-on-scroll">
                    ...
                    <h3 class="font-semibold text-2xl text-primary mb-3">High-Speed Internet Browse</h3>
                    <p class="text-gray-700">Access fast and reliable internet for research, communication, and online tasks.</p>
                </div>
                <div class="bg-cardBg p-8 rounded-xl shadow-md text-center card-hover border border-subtleBorder fade-in-on-scroll">
                    ...
                    <p class="text-gray-700">High-quality color and black & white printing, and efficient photocopying services.</p>
                </div>
                <div class="bg-cardBg p-8 rounded-xl shadow-md text-center card-hover border border-subtleBorder fade-in-on-scroll">
                    <div class="w-24 h-24 mx-auto mb-6 flex items-center justify-center rounded-full bg-primary text-white shadow-inner">
                    ...
                    <p class="text-gray-700">Convert physical documents to digital formats quickly and securely.</p>
                </div>
                <div class="bg-cardBg p-8 rounded-xl shadow-md text-center card-hover border border-subtleBorder fade-in-on-scroll">
                    <div class="w-24 h-24 mx-auto mb-6 flex items-center justify-center rounded-full bg-accent text-white shadow-inner">
                ...
                <div class="bg-cardBg p-8 rounded-xl shadow-md text-center card-hover border border-subtleBorder fade-in-on-scroll">
                    ...
                    <h3 class="font-semibold text-2xl text-primary mb-3">Online Application Assistance</h3>
                    <p class="text-gray-700">Expert help with online job applications, university admissions, and government forms.</p>
                </div>
                <div class="bg-cardBg p-8 rounded-xl shadow-md text-center card-hover border border-subtleBorder fade-in-on-scroll">
                    <div class="w-24 h-24 mx-auto mb-6 flex items-center justify-center rounded-full bg-accent text-white shadow-inner">
                        <i data-lucide="mail" class="w-16 h-16"></i>
                    </div>
                    <h3 class="font-semibold text-2xl text-primary mb-3">Email & Communication Setup</h3>
                    <p class="text-gray-700">Assistance with creating email accounts, setting up video calls, and digital communication.</p>
                </div>
            </div>
        </div>
    </section>

    <!-- Printing & Stationery Services Section -->
    <section id="printing" class="py-16 md:py-24 text-textDark bg-section-parallax-2">
        <div class="w-full px-4 md:px-8 lg:px-16 py-8 bg-cardBg rounded-xl shadow-lg fade-in-on-scroll">
            <h2 class="text-4xl md:text-5xl font-playfair font-bold mb-12 text-center text-primary">Printing & Stationery Services</h2>
            <p class="text-lg text-gray-700 leading-relaxed text-center max-w-4xl mx-auto mb-16">
                High-quality printing solutions and a comprehensive range of office stationery to meet all your needs.
            </p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                <div class="bg-cardBg p-8 rounded-xl shadow-md text-center card-hover border border-subtleBorder fade-in-on-scroll">
                    ...
                    <h3 class="font-semibold text-2xl text-primary mb-3">Digital Printing</h3>
                    <p class="text-gray-700">Fast and vibrant digital printing for brochures, flyers, reports, and presentations.</p>
                </div>
                <div class="bg-cardBg p-8 rounded-xl shadow-md text-center card-hover border border-subtleBorder fade-in-on-scroll">
                    <div class="w-24 h-24 mx-auto mb-6 flex items-center justify-center rounded-full bg-accent text-white shadow-inner">
                        <i data-lucide="maximize" class="w-16 h-16"></i>
                    </div>
                    <h3 class="font-semibold text-2xl text-primary mb-3">Large Format Printing</h3>
                    <p class="text-gray-700">Posters, banners, and architectural drawings printed with exceptional clarity and detail.</p>
                </div>
                <div class="bg-cardBg p-8 rounded-xl shadow-md text-center card-hover border border-subtleBorder fade-in-on-scroll">
                    <div class="w-24 h-24 mx-auto mb-6 flex items-center justify-center rounded-full bg-primary text-white shadow-inner">
                        <i data-lucide="pencil-ruler" class="w-16 h-16"></i>
                    </div>
                    <h3 class="font-semibold text-2xl text-primary mb-3">Custom Stationery Design</h3>
                    <p class="text-gray-700">Personalized business cards, letterheads, envelopes, and official documents.</p>
                </div>
                <div class="bg-cardBg p-8 rounded-xl shadow-md text-center card-hover border border-subtleBorder fade-in-on-scroll">
                    <div class="w-24 h-24 mx-auto mb-6 flex items-center justify-center rounded-full bg-accent text-white shadow-inner">
                        <i data-lucide="clipboard-list" class="w-16 h-16"></i>
                    </div>
                    <h3 class="font-semibold text-2xl text-primary mb-3">Office Supplies</h3>
                    <p class="text-gray-700">A wide range of essential office supplies, from pens and paper to file trays and whiteboards.</p>
                </div>
            </div>
        </div>
    </section>

    <!-- Business & Compliance Services Section -->
    <section id="business" class="py-16 md:py-24 text-textDark bg-section-parallax-3">
        <div class="w-full px-4 md:px-8 lg:px-16 py-8 bg-cardBg rounded-xl shadow-lg fade-in-on-scroll">
            <h2 class="text-4xl md:text-5xl font-playfair font-bold mb-12 text-center text-primary">Business & Compliance Services</h2>
            <p class="text-lg text-gray-700 leading-relaxed text-center max-w-4xl mx-auto mb-16">
                Expert financial and regulatory support to ensure your business thrives and remains compliant.
            </p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                <div class="bg-cardBg p-8 rounded-xl shadow-md text-center card-hover border border-subtleBorder fade-in-on-scroll">
                    ...
                    <h3 class="font-semibold text-2xl text-primary mb-3">KRA Services</h3>
                    <p class="text-gray-700">Comprehensive KRA tax filing, PIN registration, and iTax support.</p>
                </div>
                <div class="bg-cardBg p-8 rounded-xl shadow-md text-center card-hover border border-subtleBorder fade-in-on-scroll">
                    <div class="w-24 h-24 mx-auto mb-6 flex items-center justify-center rounded-full bg-accent text-white shadow-inner">
                        <i data-lucide="briefcase" class="w-16 h-16"></i>
                    </div>
                    <h3 class="font-semibold text-2xl text-primary mb-3">Business Registration</h3>
                    <p class="text-gray-700">Assistance with company registration, business name registration, and legal compliance.</p>
                </div>
                <div class="bg-cardBg p-8 rounded-xl shadow-md text-center card-hover border border-subtleBorder fade-in-on-scroll">
                    <div class="w-24 h-24 mx-auto mb-6 flex items-center justify-center rounded-full bg-primary text-white shadow-inner">
                        <i data-lucide="trending-up" class="w-16 h-16"></i>
                    </div>
                    <h3 class="font-semibold text-2xl text-primary mb-3">Financial & Tax Advisory</h3>
                    <p class="text-gray-700">Expert guidance on financial planning, tax optimization, and accounting practices.</p>
                </div>
                <div class="bg-cardBg p-8 rounded-xl shadow-md text-center card-hover border border-subtleBorder fade-in-on-scroll">
                    <div class="w-24 h-24 mx-auto mb-6 flex items-center justify-center rounded-full bg-accent text-white shadow-inner">
                        <i data-lucide="user-check" class="w-16 h-16"></i>
                    </div>
                    <h3 class="font-semibold text-2xl text-primary mb-3">E-Citizen Services</h3>
                    <p class="text-gray-700">Support for various eCitizen services, including birth certificates, police clearance, and more.</p>
                </div>
                <div class="bg-cardBg p-8 rounded-xl shadow-md text-center card-hover border border-subtleBorder fade-in-on-scroll">
                    <div class="w-24 h-24 mx-auto mb-6 flex items-center justify-center rounded-full bg-primary text-white shadow-inner">
                        <i data-lucide="shield-check" class="w-16 h-16"></i>
                    </div>
                    <h3 class="font-semibold text-2xl text-primary mb-3">NSSF & NHIF Compliance</h3>
                    <p class="text-gray-700">Assistance with NSSF and NHIF registration, contributions, and compliance.</p>
                </div>
            </div>
        </div>
    </section>
